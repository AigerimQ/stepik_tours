...
tours = {
    ...
    8: {
        ...
        "departure": "kazan",
        "picture": "https://images.unsplash.com/photo-1549109786-eb80da56e693?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&"
                   "auto=format&fit=crop&w=800&q=60",
        "price": 44000,
        "stars": "4",
        "country": "Тайланд",
    ...
    11: {
        ...
        "description": "В доме очень хороший двор с большими камнями, похожими на озеро. В задней части дома окна прост"
                       "орные, с большими окнами, они светлее, чтобы улучшить впечатление. Снаружи есть пять маленьких "
                       "деревьев. Двор в очень хорошем состоянии и очень живописный. Есть пруд для развлечения",
        "departure": "spb",
    ...
    13: {
        ...
        "description": "Снаружи этот дом выглядит очень элегантно. Он был построен из коричневого кирпича и имеет "
                       ...
                       "и покрыта коричневой черепицей. Один большой дымоход высовывает центр крыши. На крыше нет окон."
